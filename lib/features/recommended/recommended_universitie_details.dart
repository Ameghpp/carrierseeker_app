...
class RecommendedUniversitieDetails extends StatefulWidget {
  final int universitieId;
  const RecommendedUniversitieDetails({super.key, required this.universitieId});

  @override
  State<RecommendedUniversitieDetails> createState() =>
      _RecommendedUniversitieDetailsState();
}

class _RecommendedUniversitieDetailsState
    extends State<RecommendedUniversitieDetails> {
  ...
  void getCollages() {
    _collagesBloc
        .add(GetRecommendedCollagesEvent(params: {'id': widget.universitieId}));
  }
          ...
          child: BlocConsumer<CollagesBloc, CollagesState>(
            listener: (context, collageState) {
              if (collageState is CollagesFailureState) {
                ...
                //todo
              } else if (collageState is RecommendedCollagesGetSuccessState) {
